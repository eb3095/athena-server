...
DEFAULT_TTS_CONVERSION_PREPROMPT = "Strip markdown syntax from this text. Remove **, *, #, `, ```, -, and similar formatting characters. Keep all words exactly the same - do not rephrase, reorder, add, or remove any words. Just delete the formatting symbols. Output only the cleaned text."
